...
def main(request) :
    ...
    like_movies = Movie.objects.order_by('-vote_average')[:20]

    print(latest_movies[0].vote_average)
...
def movie_data(request) :
    ...
    for page in range(1,2) :
        ...
        for movie in data_list :
            ...
            data = res2.json()
            serializer = MovieDetailSerializer(data=data, many=True)
